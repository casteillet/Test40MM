        ...
        private static void RegisterApplicationActions()
        {
            ...
            if (mousePresent)
            {
                RuntimeDebugSystem.RegisterActions(applicationGroup,
                    ...
                    .WithActionGet(() => RuntimeDebugSystem.Instance.runtimeDebugUI.showCursorAfterClose)
                    .WithActionSet((isOn) => RuntimeDebugSystem.Instance.runtimeDebugUI.showCursorAfterClose = isOn)
                );
            }
        }
    }
